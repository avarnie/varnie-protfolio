      ...
      <div class="relative bg-gray-50 px-4 pt-16 pb-20 sm:px-6 lg:px-8 lg:pt-24 lg:pb-28">
        ...
        <div class="relative mx-auto max-w-7xl">
          ...
          <div class="mx-auto mt-12 grid max-w-lg gap-5 lg:max-w-none lg:grid-cols-3">
                {
                posts.map(post => <div class="flex flex-col overflow-hidden rounded-lg shadow-lg">
                ...
                <div class="flex flex-1 flex-col justify-between bg-white p-6">
                  <div class="flex-1">
                    <p class="text-sm font-medium text-indigo-600">
                      {post.tags.split(',').map(tag => <a href="#" class="hover:underline">
                        {tag}
                      </a>)}
                  ...
                  <div class="mt-6 flex items-center">
                    ...
                    <div class="ml-3">
                      ...
                      <div class="flex space-x-1 text-sm text-gray-500">
                        <time datetime="2020-03-16">{createDate(post.created_at.seconds)}</time>
