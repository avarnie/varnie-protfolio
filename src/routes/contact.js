    ...
    <div class="max-w-[700px] mx-auto px-3 lg:px-6">
      ...
      <form>
        <div class="form-group mb-6">
          <label class="text-xl font-bold mb-12">Name</label><br />
        ...
        <div class="form-group mb-6">
          <label class="text-xl font-bold mb-12">Email</label><br />
        ...
        <div class="form-group mb-6">
          <label class="text-xl font-bold mb-12">Message</label><br />
          <textarea class="
            form-control
            block
            w-full
